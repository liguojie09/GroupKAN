...
def parse_args():
    ...
    parser.add_argument('--name', default="KANet_BUSI", help='model name')
    parser.add_argument('--output_dir', default='checkpoints', help='ouput dir')
...
def main():
    ...
    model = KANet.__dict__[config['arch']](config['num_classes'], config['input_channels'], config['deep_supervision'],
                                           ...
                                           active_kan_group=config['active_kan_group'],
                                           group_kan_num=config['group_kan_num'])
    model = model.cuda()
